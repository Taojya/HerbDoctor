...
export default {
  ...
  methods: {
    ...
    Hot: function() {
      this.urlcurrent = "mobile/meet/?sort=hot&"
      this.all = false
      this.hot = true
      this.now = false
      this.recommend = false
    ...
    Now: function() {
      this.urlcurrent = "mobile/meet/?sort=new&"
      this.all = false
      this.hot = false
      this.now = true
      this.recommend = false
    ...
    Recommend: function() {
      this.urlcurrent = "mobile/meet/?sort=recommend&"
      this.all = false
      this.hot = false
      this.now = false
      this.recommend = true

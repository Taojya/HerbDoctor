...
export default {
    ...
    methods: {
        All() {
            ...
            this.myurl = "mobile/video/?type=vip&"
        },
        Hot() {
            this.all = false
            this.hot = true
            this.vnew = false
            this.recommend = false
            this.myurl = "mobile/video/?sort=hot&type=vip&"
        },
        New() {
            this.all = false
            this.hot = false
            this.vnew = true
            this.recommend = false
            this.myurl = "mobile/video/?sort=new&type=vip&"
        },
        Recommend() {
            this.all = false
            this.hot = false
            this.vnew = false
            this.recommend = true
            this.myurl = "mobile/video/?sort=recommend&type=vip&"
        } 
    }
};
</script>
